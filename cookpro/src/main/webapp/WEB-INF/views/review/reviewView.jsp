...
<script>
	...
	function fn_modify_article(obj){
		obj.action = "${contextPath}/review/modArticle.do";
		obj.submit();
	}
		...
		<tr id="tr_btn">
			<td colspan="3" align="center"><c:if
					...
					<input class="button" type="button" value="삭제하기"
						onclick="fn_remove_article('${contextPath}/review/removeArticle.do', ${article.articleNo })">
				...
				onclick="fn_reply_form('${contextPath }/review/reviewReplyForm.do', ${article.articleNo }, '${isLogOn }','${contextPath }/member/loginForm.do')">
			</td>
		</tr>
	</table>
</form>
