...
<form name="reviewForm" method="post" action="${contextPath }/review/addNewArticle.do" enctype="multipart/form-data">
	
	<table border="0" align="center">
		<h1 style="text-align: center; color:#FF7629;">리뷰 새 글 쓰기</h1>
		<tr>
